...
\draw (10.5,9.5) to[european resistor,l=$\dot{Z_0}$,i=$\vec{I_0}$] (12.5,9.5) -| ++(0.5,0)  |- ++(-0.5,1);
\draw (10.5,13) to[sinusoidal voltage source,l=$\vec{E_d^0}$] (10.5,15);
\draw (10.5,15) to[european resistor,l=$\dot{Z_d}$,i=$\vec{I_d}$] (12.5,15) -| ++(1,0) |- ++(0,-3) 
to[european resistor,l={$3\dot{Z_g}$}]++(0,-1.5) |- ++(-1,-2.5) ;
\draw (10.5,12) to[european resistor,l=$\dot{Z_i}$,i=$\vec{I_i}$] (12.5,12) -| ++(0.5,0)  |- ++(-0.5,1);
